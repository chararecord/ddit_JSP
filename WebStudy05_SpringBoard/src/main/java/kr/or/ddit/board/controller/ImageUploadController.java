...
public class ImageUploadController {
	...
	@ResponseBody // 여기서 반환되는 객체를 마샬링 해서 응답 객체의 body를 만들어줌 - 얘가 걍 jsonView 역할 해줌
	public Map<String, Object> uploadImage(@RequestPart MultipartFile upload
			, HttpServletRequest req) throws IllegalStateException, IOException {
//		1. 업로드 : 이진 데이터 저장(web resource)
