...
////		URL resourceURL = loader.getResource("kr/or/ddit/props/DataStore.properties"); // 얘는 슬래시 붙이면 에러
////		URL resourceURL = DescriptionServlet.class.getResource("/kr/or/ddit/props/DataStore.properties"); // 클래스 패스 아래에서 찾아라
//		URL resourceURL = DescriptionServlet.class.getResource("../props/DataStore.properties"); // DescriptServlet이랑
...
//		locale-specific-object
		// baseName 형태 : 최상위 패키지부터 시작, 확장자X, 로케일정보X, / -> . 으로 교체
