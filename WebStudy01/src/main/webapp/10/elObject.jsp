...
<pre>
	<!-- 1 ~ 5 까지 전부 Map -->
	1. scope 객체(Map&lt;String, Object%gt;) : pageScope, requestScope, sessionScope, applicationScope
	...
	4. 쿠키 객체 : cookie(Map&lt;String,Cookie&gt;) <% Cookie test; %>
		<%=request.getCookies() %>
...
<!-- 현재의 요청의 파라미터 중 (sample) 이라는 이름의 파라미터 값을 출력하라 (EL) -->
