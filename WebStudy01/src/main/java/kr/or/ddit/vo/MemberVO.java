...
/**
 * VO(Value Object), DTO(Data Transfer Object), JavaBean, Model -> 다 같은 역할
 * 
 * JavaBean 규약
...
public class MemberVO implements Serializable{
	...
	public String toString() {
		return "MemberVO [memId=" + memId + ", memName=" + memName + ", memBir=" + memBir + ", memZip=" + memZip
				...
				+ memMileage + ", memDelete=" + memDelete + ", getMemId()=" + getMemId() + ", getMemPass()="
				+ getMemPass() + ", getMemName()=" + getMemName() + ", getMemRegno1()=" + getMemRegno1()
				+ ", getMemRegno2()=" + getMemRegno2() + ", getMemBir()=" + getMemBir() + ", getMemZip()=" + getMemZip()
				+ ", getMemAdd1()=" + getMemAdd1() + ", getMemAdd2()=" + getMemAdd2() + ", getMemHometel()="
				+ getMemHometel() + ", getMemComtel()=" + getMemComtel() + ", getMemHp()=" + getMemHp()
				+ ", getMemMail()=" + getMemMail() + ", getMemJob()=" + getMemJob() + ", getMemLike()=" + getMemLike()
				+ ", getMemMemorial()=" + getMemMemorial() + ", getMemMemorialday()=" + getMemMemorialday()
				+ ", getMemMileage()=" + getMemMileage() + ", getMemDelete()=" + getMemDelete() + ", hashCode()="
