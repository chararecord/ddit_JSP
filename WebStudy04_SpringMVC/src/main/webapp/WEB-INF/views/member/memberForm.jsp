	...
	<form:form modelAttribute="member" enctype="multipart/form-data">
		<table class="table table-bordered">
			...
			<tr>
				...
				<td>
					<!-- 코드 어시스턴트에 보이지 않아도 html 태그가 가지고 있는 속성이면 사용가능 -->
					<form:input path="memImage" type="file" cssClass="form-control" />
<!-- 					<input type="file" name="memImage" accpe="image/*" /> -->
			...
			<tr>
				...
				<td>
					<form:input path="memBir" type="date" cssClass="form-control"/>
			...
			<tr>
				...
				<td>
					<form:input path="memMail" type="email" cssClass="form-control"/>
			...
			<tr>
				...
				<td>
					<form:input path="memMemorialday" type="date" cssClass="form-control"/>
			...
			<tr>
				...
				<td>
					<form:input path="memMileage" cssClass="form-control"/>
